...
(function ($) {
 ...
 if($('.main-header')[0]) {$('.main-header')[0].classList.forEach(function (className) {
  ...
  if($('.main-sidebar')[0]) {$('.main-sidebar')[0].classList.forEach(function (className) {
 ...
 if($('.brand-link')[0]) {$('.brand-link')[0].classList.forEach(function (className) {
