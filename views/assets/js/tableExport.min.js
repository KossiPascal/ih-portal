...
(function ($) {
  $.fn.tableExport = function (options) {
    ...
    defaults.mso.pageOrientation =
      defaults.mso.pageOrientation.substr(0, 1) === 'l' ? 'landscape' : 'portrait';
    ...
    if (defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt') {
      ...
      if (defaults.outputMode === 'window') {
        downloadFile(
          false,
          'data:text/' + (defaults.type === 'csv' ? 'csv' : 'plain') + ';charset=utf-8,',
          csvData
        );
        return;
      }
      ...
      docFile += '<body>';
      docFile +=
        '<div class="Section' + (defaults.mso.pageOrientation === 'landscape' ? '2' : '1') + '">';
      docFile += docData;
      docFile += '</div>';
      docFile += '</body>';
      docFile += '</html>';
      ...
      if (defaults.pdfmake.enabled === true) {
        ...
        doc.html(el[0], {
          ...
          html2canvas: {
            scale:
              (doc.internal.pageSize.width - defaults.jspdf.margins.left * 2) / el[0].scrollWidth,
          },
            ...
            .each(function () {
              ...
              if (typeof atOptions.createdCell !== 'function') {
                atOptions.createdCell = function (cell, data) {
                  ...
                  cell.styles.halign =
                    atOptions.styles.halign === 'inherit' ? 'center' : atOptions.styles.halign;
    ...
    function isVisible($element) {
      ...
      const isElementVisible =
        isCell || isRow ? isTableElementVisible($element) : $element.is(':visible');
    ...
    function prepareAutoTableText(cell, data, cellopt) {
      ...
      if (cs >= 0) {
        ...
        if (cell.styles.valign === 'middle' || cell.styles.valign === 'bottom') {
          const splittedText =
            typeof cell.text === 'string' ? cell.text.split(/\r\n|\r|\n/g) : cell.text;
          const lineCount = splittedText.length || 1;
          if (lineCount > 2)
            cell.textPos.y -=
              (((2 - FONT_ROW_RATIO) / 2) * data.row.styles.fontSize * (lineCount - 2)) / 3;
        }
        return true;
      } else return false;
    }
    ...
    function replaceAll(string, find, replace) {
      return string == null
        ? ''
        : string.toString().replace(new RegExp(escapeRegExp(find), 'g'), replace);
    }
            ...
            if (
              ...
              if (number !== false) {
                ...
                result =
                  ...
                  (defaults.numbers.output.thousandsSeparator
                    ? (mod
                        ? frac[0].substr(0, mod) + defaults.numbers.output.thousandsSeparator
                        : '') +
                      frac[0]
                        .substr(mod)
                        .replace(
        ...
        for (_C = C = 0; _C < elts.length; ++_C) {
          ...
          if (v != null) {
            ...
            if ($aTag && $aTag.length) {
              ...
              const hyperlink =
                href !== ''
                  ? '=HYPERLINK("' + href + (content.length ? '","' + content : '') + '")'
                  : '';
              if (hyperlink !== '') {
    ...
    function xlsxToNumber(s, numbersFormat) {
      ...
      if ('' !== numbersFormat.thousandsSeparator)
        ss = ss.replace(
          new RegExp('([\\d])' + numbersFormat.thousandsSeparator + '([\\d])', 'g'),
          '$1$2'
        );
    ...
    function jsPdfAutoTable(doc, headers, data, options) {
      ...
      const firstRowHeight =
        jsPdfTable.rows[0] && jsPdfSettings.pageBreak === 'auto' ? jsPdfTable.rows[0].height : 0;
      ...
      if (
        (jsPdfSettings.pageBreak === 'always' && jsPdfSettings.startY !== false) ||
    ...
    function jsPdfCreateModels(inputHeaders, inputData) {
      ...
      inputHeaders.forEach(function (rawColumn, dataKey) {
        ...
        cell.text = '' + cell.raw;
        cell.contentWidth =
          cell.styles.cellPadding * 2 + jsPdfGetStringWidth(cell.text, cell.styles);
    ...
    function jsPdfCalculateWidths() {
      ...
      const maxTableWidth =
        jsPdfDoc.internal.pageSize.width - jsPdfSettings.margin.left - jsPdfSettings.margin.right;
