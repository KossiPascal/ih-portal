          ...
          var d = Math.PI / 2,
            ...
            m = function (a) {
              ...
              if (((this.datum_type = h), a)) {
                if (
                  (a.datumCode && 'none' === a.datumCode && (this.datum_type = i), a.datum_params)
                ) {
                  for (var b = 0; b < a.datum_params.length; b++)
                    a.datum_params[b] = parseFloat(a.datum_params[b]);
                  (0 !== a.datum_params[0] || 0 !== a.datum_params[1] || 0 !== a.datum_params[2]) &&
                    (this.datum_type = e),
              ...
              return (
                ...
                Math.abs(this.sin_p12 - 1) <= f
                  ...
                  : ((b = Math.sqrt(a.x * a.x + a.y * a.y)),
                    ...
                    (r = Math.atan(
                      ((1 - (this.es * I * this.sin_p12) / Math.sin(A)) * Math.tan(A)) /
                        (1 - this.es)
                    )),
                    (a.x = q),
                    (a.y = r),
        ...
        function (a, b, c) {
          ...
          (c.init = function () {
            if (
              ...
              (this.ns =
                Math.abs(this.lat1 - this.lat2) > d ? Math.log(g / k) / Math.log(h / l) : b),
        ...
        function (a, b, c) {
          ...
          (c.init = function () {
            ...
            this.uc = this.no_off
              ...
              : ((-1 * this.al) / this.bl) * Math.atan2(Math.sqrt(g * g - 1), Math.cos(this.alpha));
          }),
            (c.forward = function (a) {
              var b,
                c,
                ...
                if (Math.abs(e + this.a * this.lat0) <= k)
                  ...
                  for (f = m; f; --f)
                    if (
                      ((o = Math.tan(l)),
                      (n =
                        (-1 * (g * (l * o + 1) - l - 0.5 * (l * l + i) * o)) / ((l - g) / o - 1)),
                      (l += n),
                      Math.abs(n) <= k)
                    ) {
                      c = l;
            ...
            (c.init = function () {
              (this.coslat0 = Math.cos(this.lat0)),
                ...
                this.sphere
                  ...
                  : (Math.abs(this.coslat0) <= e && (this.con = this.lat0 > 0 ? 1 : -1),
                    (this.cons = Math.sqrt(
        ...
        function (a, b, c) {
          ...
          (c.init = function () {
            ...
            (c.forward = function (a) {
              ...
              return (
                (t =
                  (Math.PI * this.R * (r * u - l * Math.sqrt((s + m) * (m + 1) - u * u))) /
                  (s + m)),
        ...
        function (a, b, c) {
          ...
          function h(a) {
            ...
            'GEOGCS' === a.type
              ...
              : (a.projName =
                  'object' == typeof a.PROJECTION ? Object.keys(a.PROJECTION)[0] : a.PROJECTION),
              a.UNIT &&
