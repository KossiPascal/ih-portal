  ...
  return (function (t) {
            ...
            (t.prototype.applyStyles = function (e, n) {
              ...
              if (
                ...
                var l = this.getFontList()[e.font],
                  a = e.fontStyle;
                l && a && -1 === l.indexOf(a) && this.jsPDFDocument.setFontStyle(l[0]),
    ...
    function (t, e, n) {
      ...
      (e.drawTable = function (t, e) {
        ...
        ('always' === n.pageBreak || (null != n.startY && g > y.pageSize().height)) &&
          (c(y), (f.y = s.top));
        var v = a.assign({}, f);
        ...
        function t(t, e, n) {
          ...
          null == t || 'object' != typeof t || Array.isArray(t)
            ...
            : ((this.rowSpan = t.rowSpan || 1),
              ...
              (i =
                null !== (r = null !== (o = t.content) && void 0 !== o ? o : t.title) &&
                void 0 !== r
                  ? r
                  : t),
        ...
        (t.API.autoTable = function () {
          ...
          (t.API.autoTableHtmlToJson = function (t, e) {
            if ((void 0 === e && (e = !1), 'undefined' == typeof window))
              return (
                console.error('Cannot run autoTableHtmlToJson in non browser environment'), null
              );
