...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var tabUrl= link!=undefined ? `${link}`[0]==='/'?`${link}`.substring(1):`${link}`:'#';
    ...
    IFrame._jQueryInterface = function _jQueryInterface(config) {
      if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        localStorage.setItem('IFrame', JSON.stringify(_options));
        ...
        new IFrame($__default["default"](this), JSON.parse(localStorage.getItem('IFrame')))._initFrameElement();
      }
    };
