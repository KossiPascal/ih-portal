...
AppDataSource
  ...
  // const apiTarget = 'https://localhost:9998';
  const apiTarget = 'https://localhost:9998/api/chws-meg?api_access_key=afrikDigitalAZ-FGHJ@04jdkj2024&start_date=2023-10-26&end_date=2023-12-25&districts=x8f4IKAC7TO&sites=[552aafc3-11a9-4209-8f17-d1ea13bab8d5]&chws=[eafabdf9-c16a-44d5-83e4-a619d5478919]';
