...
import { Chws, ChwsDataFormDb, CompareData, Dhis2Sync, Districts, Sites } from "@ih-app/models/Sync";
...
export class HighchartMap1Component implements OnInit {
    ...
    //                     // var dist = convertLatLonToXY({lat:parseFloat(e.geolocation.latitude), lon:parseFloat(e.geolocation.longitude)});
    //                     // var dist = getXYforLatLng(parseFloat(e.geolocation.latitude),parseFloat(e.geolocation.longitude), 1);

    //                     // var dist = degrees2meters(parseFloat(e.geolocation.latitude), parseFloat(e.geolocation.longitude));
    //                     var dist = LatLonToMercator(parseFloat(e.geolocation.latitude), parseFloat(e.geolocation.longitude));
