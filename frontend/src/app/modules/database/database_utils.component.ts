...
export class DatabaseUtilsComponent implements OnInit {
  ...
  ParamsToFilter(): FilterParams {
    var params: FilterParams = {
      ...
      sources: Functions.returnDataAsArray(this.dataListToDeleteForm.value.sources) as string[],
      districts: Functions.returnDataAsArray(this.dataListToDeleteForm.value.districts) as string[],
