...
export function getAgeInMilliseconds(birth_date?: string) {
  if (birth_date != null) {
...
export function getAgeInYear(birth_date: string, withUtc: boolean = true) {
...
export function getAgeInMonths(birth_date: string, round: boolean = false) {
  var ageInMs = getAgeInMilliseconds(birth_date);
  if (ageInMs != null) {
...
export function getAgeInDays(birth_date: string) {
  var ageInMs = getAgeInMilliseconds(birth_date);
  if (ageInMs != null) {
